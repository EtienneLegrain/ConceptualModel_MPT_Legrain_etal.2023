...
#######################################################
#Parameters chosen by the user (could be pasted directly from the GRAD_simulation.py program output)

#Best fit parameters
BestParamPlot = (0.7265624639702665, 0.44976733396348695, 0.5298860390826086, 0.7058639152005617, -0.031366280278831184, 7.595301792289637, 17.03262809948767, -1.2317711345984004, 8.112421350564837, 107.25499051223929, 3.4284544122934655, 16.154255200646322, 0.031026719264074822)
...
def Phi(i,v):
    ...
    if S[0] == "g":
        if test_threshold_gd>(v0-C*(2000-(i/2))) and test_threshold_dg>(v1):
            S[0] = "d"
            S[1] = i/2
    else :
        if test_threshold_dg<(v1) and test_threshold_gd<(v0-C*(2000-(i/2))):
            S[0] = "g"
