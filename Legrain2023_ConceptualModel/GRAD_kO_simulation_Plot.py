...
#######################################################
#BestParamPlot chosen by the user (could be pasted directly from the GRAD_kO_simulation.py program output)

#Best fit BestParamPlot
BestParamPlot = (0.2997719429853139, -0.2618747513856085, 0.5986949819190089, 0.6733292241956406, -0.14588698619791127, 8.894462488020233, 25.58764566123469, -0.057155153464381214, 10.650477761141655, 89.8270511706374, -0.4058679534055527, 9.434757034071081, 0.0003045454654769704)
...
ax.plot(time,icevolume,'g',label="Model")
...
ax.plot(time,residuals,'g--',label="Model")
show()
plt.gca().invert_yaxis()
xticks([0,100,200,300,400,500,600,700,800,900,1000,1100,1200,1300,1400,1500,1600,1700,1800,1900,2000])
