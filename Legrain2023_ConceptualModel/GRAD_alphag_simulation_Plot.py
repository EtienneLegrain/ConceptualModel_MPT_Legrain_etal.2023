...
#######################################################
#BestParamPlot chosen by the user (could be pasted directly from the GRAD_alphag_simulation.py program output)

#Best fit BestParamPlot
BestParamPlot = (0.594149511233805, 0.2727894469059368, 0.7959618074179664, 1.2585093204152362, -0.007999427596465242, 9.216636044090802, 25.495399847288617, -1.068584498151437, 10.52570538086479, 93.31064397822807, 1.0931681601191052, 26.40919790379664, 0.000717314875206365)
...
def Phi(i,vt,BestParamPlot):
    ...
    if S[0] == "g" :
        dvdt = -BestParamPlot[0]*Esitr[i]-BestParamPlot[1]*Ecotr[i]-BestParamPlot[2]*EnOtr[i]+BestParamPlot[3]-BestParamPlot[12]*(2000-(i/2))
    else :
