...
StartPosition = (0.3, 0.3, 0.6, 1.2, -0.1, 9, 24, -1, 10, 90, 1, 30, -0.001)
...
def Phi(i,vt,parameters):
    ...
    if S[0] == "g" :
        dvdt = -parameters[0]*Esitr[i]-parameters[1]*Ecotr[i]-parameters[2]*EnOtr[i]+parameters[3]-parameters[12]*(2000-(i/2))
    else :
...
#####################################################################
#Extraction of the best parameters list to copy and paste in the GRAD_alphag_simulation_plot.py program
...
plot(steps.get_log_prob(flat=True))
