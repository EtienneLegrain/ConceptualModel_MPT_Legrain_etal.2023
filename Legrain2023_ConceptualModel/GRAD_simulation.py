...
StartPosition = (0.7, 0.4, 0.5, 0.7, -0.03, 7.5, 17, -1, 8, 107, 3, 16, 0.03)
...
def Phi(i,vt,parameters):
    ...
    if S[0] == "g":
        if test_threshold_gd>(parameters[9]-parameters[12]*(2000-(i/2))) and test_threshold_dg>parameters[10]:
            S[0] = "d"
            S[1] = i/2*0.1
    else :
        if test_threshold_dg<parameters[10] and test_threshold_gd<(parameters[9]-parameters[12]*(2000-(i/2))):
            S[0] = "g"
