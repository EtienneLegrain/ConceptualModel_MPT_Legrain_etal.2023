...
#######################################################
#Parameters chosen by the user (could be pasted directly from the ORB_simulation.py program output)

#Best fit parameters
BestParamPlot = (1.1398148342454495, 0.17875075699339477, 0.6811359068573434, 0.6545967060146282, -0.11272301388921098, 8.563077807581152, 23.171390477345955, -0.5174997773286568, 12.381453160770874, 83.60185860143397, 7.468568271896493, 52.28614888201255)
