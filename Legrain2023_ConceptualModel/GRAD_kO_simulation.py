...
StartPosition = (0.3, -0.3, 0.5, 0.6, -0.1, 9, 25, -0.1, 10, 89, -0.4, 10, 0.001)
...
#######################################################
#Fonction Phi qui calcule la dérivée à chaque pas de temps pour le cycle 1
def Phi(i,vt,parameters):
    test_threshold_gd = parameters[6]*Esi[i]+parameters[7]*Eco[i]+(parameters[8]-parameters[12]*(2000-(i/2)))*EnOtr[i]+vt
    test_threshold_dg = parameters[6]*Esi[i]+parameters[7]*Eco[i]+(parameters[8]-parameters[12]*(2000-(i/2)))*EnOtr[i]
    if S[0] == "g":
...
aEsi1i = StartPosition[0]
aEco1i = StartPosition[1]
aO1i = StartPosition[2]
ag1i = StartPosition[3]
ad1i = StartPosition[4]
tau1i = StartPosition[5]
kEsi1i = StartPosition[6]
kEco1i = StartPosition[7]
kO1i = StartPosition[8]
v01i = StartPosition[9]
v11i = StartPosition[10]
v11i = StartPosition[10]
vi1i = StartPosition[11]
C = StartPosition[12]
S = ["g",0]

param=[aEsi1i,aEco1i,aO1i,ag1i,ad1i,tau1i,kEsi1i,kEco1i,kO1i,v01i,v11i,vi1i,C]
...
#####################################################################
#Extraction of the best parameters list to copy and paste in the GRAD_kO_simulation_plot.py program
