...
"""
import sys
sys.path.extend(['c:/users/legraine.osug-fd/appdata/local/programs/python/python311/lib/site-packages'])
...
StartPosition = (-0.1, 0.1, 0.2, 0.7, -0.1, 6, 27, -0.8, 16, 96, 9, -5, 1130, 23)
...
#####################################################################
#Extraction of the best parameters list to copy and paste in the ABR_kO_simulation_plot.py program
